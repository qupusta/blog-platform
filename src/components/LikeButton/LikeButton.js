...
import { putLikeService } from '../../service/ArticlesService'
import userActions from '../../reducers/UserReducer/UserActions'

import classes from './LikeButton.module.scss'

const LikeButton = ({ favorited, favoritesCount, slug }) => {
  ...
  return (
    <div className={classes.like}>
      ...
      >
        <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className={classes.likePic}>
          {like ? (
